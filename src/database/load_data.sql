...
\copy phu_dimension(phu_name, address, city, postal_code, province, url, latitude, latitude, phu_dim_key) from '../../data/dimensions/phu_dimension.csv' delimiter ',' csv header;
